...
import com.example.android.xyztouristattractions.provider.HilltractsTouristAttractions;
...
import static com.example.android.xyztouristattractions.provider.HilltractsTouristAttractions.ATTRACTIONS;
 ...
 */
public class HilltractsListFragment extends Fragment {
    ...
    private static List<Attraction> loadAttractionsFromLocation(final LatLng curLatLng) {
        String closestCity = HilltractsTouristAttractions.getClosestCity(curLatLng);
        if (closestCity != null) {
