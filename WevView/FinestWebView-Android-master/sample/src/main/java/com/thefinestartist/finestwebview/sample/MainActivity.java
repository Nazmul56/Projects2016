...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new FinestWebView.Builder(this)
                .titleDefault("Prothom-alo")
//                    .show("http://prothom-alo.com");
//                    .toolbarScrollFlags(0)
                .webViewJavaScriptEnabled(true)
                .webViewUseWideViewPort(false)
                .show("http://http-m-prothom--alo-com.0.freebasics.com/?iorg_service_id_internal=849824921721473%3BAfp36XeMmhrhf7d5");
...
//                    .setCustomAnimations(R.anim.fade_in_fast, R.anim.fade_out_medium, R.anim.fade_in_medium, R.anim.fade_out_fast)
 ...
 //                   .disableIconMenu(true)
                    .show("http://http-m-bdnews24-com.0.freebasics.com/bn?iorg_service_id_internal=1462586827368018%3BAfrtdQYe6UJBOyo5");
        }
    }*/
}
